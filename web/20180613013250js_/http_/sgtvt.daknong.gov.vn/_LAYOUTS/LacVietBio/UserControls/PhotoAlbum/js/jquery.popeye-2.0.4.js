...
(function($) {
    ...
    ////////////////////////////////////////////////////////////////////////////
    //  line 337 : Tắt mở caption large
    //  line 621 : Tắt mở caption  small
    ...
    $.fn.popeye = function(options) {
        ...
        return this.each(function() {
            ...
            var linksrc = img[i].getAttribute("linksrc");

            ppyStage.html('');
            ppyStage.append("<a href='" + linksrc + "'><img id='duybox' src='" + img[i].getAttribute("src") + "' width='" + opts.widthimg + "px'/></a>");
            var imgabc = document.getElementById('duybox');
            var widthd = imgabc.clientWidth;
            var heightd = imgabc.clientHeight;
            $('.ppy-placeholder').css('height', heightd + 40 + 'px');
            ppyStage.css('height', heightd + 'px');
...
/*
     FILE ARCHIVED ON 01:32:50 Jun 13, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 05:39:13 Apr 07, 2019.
...
/*
playback timings (ms):
  LoadShardBlock: 194.792 (3)
  esindex: 0.009
  captures_list: 220.757
  CDXLines.iter: 14.806 (3)
  PetaboxLoader3.datanode: 79.727 (4)
  exclusion.robots: 0.17
  exclusion.robots.policy: 0.158
  RedisCDXSource: 8.089
  PetaboxLoader3.resolve: 162.467 (2)
  load_resource: 76.186
*/